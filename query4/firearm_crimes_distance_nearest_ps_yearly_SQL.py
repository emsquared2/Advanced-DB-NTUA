...
average_distance_and_total_crimes_per_year_query = \
    "SELECT year, ROUND(AVG(distance), 3) || ' km' as average_distance, COUNT(*) AS total_crimes \
...
# Save output to hdfs
average_distance_and_total_crimes_per_year.write.csv("./output/query4/query4a2-SQL.csv", header=True, mode="overwrite")
